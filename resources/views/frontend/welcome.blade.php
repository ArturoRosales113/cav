    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center pt-4" id="pav-welcome">
            <div class="col-12 col-lg-8 text-center">
                <img src="{{ asset('img/brand/scroll-down.gif') }}" height="100px" class="d-none d-lg-inline-block" alt=""><br>
                ...
                <div class="col-12 col-lg-11 text-center pt-5">
                    ...
                    <a href="{{ route('front.index', $fam->name) }}" class="pav-pill red bold sp2">{{ $fam->display_name }}</a>
                    <div class="row py-5">
                        <div class="col-12">
