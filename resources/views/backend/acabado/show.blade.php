...
<div class="panel-header panel-header-md">
 <div class="header text-center">
  <h2 class="title">Artículos listado por Acabado</h2>
 </div>
</div>
<!-- Header -->
...
<div class="row my-5 justify-content-center align-items-center px-4">
 <div class="col col-md-8 text-center">
  <h2>Acabado "{{$acabado->display_name}}"</h2>
  <h5>Hay {{$acabado->articles->count()}} artículos con estacabado</h5>
 </div>
</div>
<!-- Toolbar -->
