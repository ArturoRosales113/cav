...
<div class="panel-header panel-header-md">
 <div class="header text-center ">
  <h3 class="title"> Crear Nueva Marca</h3>
  <a class="text-white" href="{{ route('marca.index') }}">
...
<div class="content mt-5">
 <div class="row justify-content-center py-5">
  <div class="col-10">
   <div class="card">
    <div class="card-body">
     <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('marca.store') }}">
      {{ csrf_field() }}
      <div class="form-group row justify-content-center py-5">
       <div class="col-10 col-md-5">
        ...
        <small id="nameHelp" class="form-text text-muted">Ejemplo: <i>Clavin Klein</i></small>
        @if ($errors->has('name'))
