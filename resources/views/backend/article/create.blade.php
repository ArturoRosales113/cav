            ...
            <form action="{{ route('article.store') }}" method="POST" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="form-group col-12">
                        ...
                        <textarea name="description" id="" class="form-control" cols="30" placeholder="Descripción" rows="2">{{ old('description') }}</textarea>
                    ...
                    <div class="form-group col-6">
                        ...
                        <select class="custom-select" name="brand_id">
                            ...
                            @foreach ($brands as $bds)
                                <option value="{{ $bds->id }}" {{ old('brand_id') == $bds->id ? 'selected' : ''}}>{{ $bds->display_name }}</option>
                            @endforeach
                        </select>
                        @if ($errors->has('brand'))
                        <span class="help-block">
