...
<div class="panel-header panel-header-md">
 <div class="header text-center ">
  ...
  <a class="text-white" href="{{ route('linea.index') }}">
...
<div class="content mt-5">
 <div class="row justify-content-center py-5">
  <div class="col-10">
   <div class="card">
    <div class="card-body">
     <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('linea.store') }}">
      {{ csrf_field() }}
      <div class="form-group row justify-content-center py-5">
       <div class="col-10 col-md-5">
        ...
        <small id="nameHelp" class="form-text text-muted">Ejemplo: <i>Ropa para Dama, Calzado</i></small>
        @if ($errors->has('name'))
